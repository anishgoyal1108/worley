...
% main color
\definecolor{theme-1}{HTML}{ef4444} % #ef4444
\definecolor{theme-2}{HTML}{f97316} % #f97316
  ...
  \begin{columns}[t]
    ...
    \begin{column}{\colwidth}
      ...
      \begin{block}{System Architeture}
        \begin{figure}[ht]
          \centering
          \includegraphics[width=0.55\linewidth]{images/flowchart.png}
    ...
    \begin{column}{\colwidth}
      \begin{block}{Introduction}
        The Final Engineering Project for the 60th Georgia Governor's Honor Program was an ambitious endeavor that spanned over 9 days, with a modest budget of \$150.
